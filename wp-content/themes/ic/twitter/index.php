...
$twitter_app_consumer_key = get_option('cebo_consumer_key');
$twitter_app_consumer_secret = get_option('cebo_consumer_secret');
$twitter_app_user_token = get_option('cebo_access_token');
$twitter_app_user_secret = get_option('cebo_access_token_secret');
