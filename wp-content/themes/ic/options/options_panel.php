...
<div class="wrap" id="msn_container">
  ...
  <form action="" enctype="multipart/form-data" id="ofform">
    ...
    <div class="theme_name"><span>Murray Hill East Suites</div>
</div>
...
$options[] = array( "name" => __('Footer Background Image 1','cebolang'),
...
$options[] = array( "name" => __('Footer Background Image 2','cebolang'),
			"desc" => __('Upload the large background pic for the footer area. It can be anything. A good size is a large image 1,000 x 600. ','cebolang'),
			"id" => $shortname."_footerpic_two",
			"std" => "",
			"type" => "upload");

$options[] = array( "name" => __('Footer Background Image 3','cebolang'),
			"desc" => __('Upload the large background pic for the footer area. It can be anything. A good size is a large image 1,000 x 600. ','cebolang'),
			"id" => $shortname."_footerpic_three",
			"std" => "",
			"type" => "upload");
