...
$meta_boxer = array(
	...
	'fields' => array(
		...
		array( 
 		...
 		array( 
	          "name" => "Enable slider",
	          "desc" => "Check to activate the slider for this page",
	          "id" => $prefix."_enable_slider",
	          "type" => "checkbox",
	          "std" => ""
	    	  )
 		,		
 		array( 
	          "name" => "Enable Sidebar Gallery",
	          "desc" => "Check to activate the sidebar gallery for this page",
	          "id" => $prefix."_enable_side_gallery",
	          "type" => "checkbox",
	          "std" => ""
	    	  )
